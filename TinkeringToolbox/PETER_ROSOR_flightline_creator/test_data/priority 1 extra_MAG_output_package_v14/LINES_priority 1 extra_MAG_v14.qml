...
<qgis styleCategories="Symbology" version="3.34.3-Prizren">
  <renderer-v2 forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1" symbollevels="0">
    <symbols>
      <symbol name="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" force_rhr="0">
        ...
        <layer pass="0" class="SimpleLine" id="{7b87c70a-4364-4d68-acc0-e2b7d1eaf337}" locked="0" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" force_rhr="0">
        ...
        <layer pass="0" class="SimpleLine" id="{4fa61a97-7d8d-4abc-ad1c-7a6ec5557936}" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
