...
def main(settings_path):
    ...
    if everything_everywhere_all_at_once.output_lkm:
        ...
        try:
            output_lkm_excel_file_path = str(
                output_lkm_deploy_to_excel_Sharj.create_excel_file(folder_path=input_folder,
                                                                   total_point_lkm=total_point_lkm,
                                                                   total_line_lkm=total_line_lkm))
            try:
