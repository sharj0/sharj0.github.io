...
def merge_two_tiffs(Ortho_photo_1_file_path,
    ...
    output_folder_testing_override = r"R:\ORTHO_STUFF\BAN_TIMMINS\needs_splitting_and_patching\TOF_2_26_to_51_Merge_5_GSD_v3"
    ...
    overlap_geotransform, overlap_shape, overlap_mask_number_of_pixels, start_pix_overall, end_pix_overall \
